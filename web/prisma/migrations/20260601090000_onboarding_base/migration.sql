...
CREATE UNIQUE INDEX IF NOT EXISTS "UserAccount_clerkId_key"
  ON "UserAccount"("clerkId");
...
CREATE UNIQUE INDEX IF NOT EXISTS "TeamMembership_userId_key"
...
CREATE TABLE IF NOT EXISTS "PlayerProfile" (
  ...
  CONSTRAINT "PlayerProfile_userId_fkey"
    FOREIGN KEY ("userId") REFERENCES "UserAccount"("id")
    ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE UNIQUE INDEX IF NOT EXISTS "PlayerProfile_userId_key"
  ON "PlayerProfile"("userId");
CREATE UNIQUE INDEX IF NOT EXISTS "PlayerProfile_handle_key"
