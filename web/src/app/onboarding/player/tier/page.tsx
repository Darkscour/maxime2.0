...
export default async function PlayerTierOnboardingPage({
  searchParams,
}: {
  ...
  await enforceOnboardingRoute("/onboarding/player/tier", {
    testMode,
    reviseMode,
  });
  ...
  return (
    <div>
      <AccountTierSelection
        ...
        collegiateHref={buildOnboardingHref("/onboarding/player", {
          ...query,
          tier: "collegiate",
        })}
        grassrootsHref={buildOnboardingHref("/onboarding/player", {
          ...query,
          tier: "grassroots",
        })}
      />
