        ...
        <div className="grid items-center gap-10 md:grid-cols-2 md:gap-12 lg:gap-16">
          <div className="text-center md:text-left">
            ...
            <motion.h1
              ...
              className="font-heading mt-4 text-5xl font-semibold tracking-tight text-white sm:text-6xl lg:text-6xl xl:text-7xl"
            >
            ...
            <motion.p
              ...
              className="mx-auto mt-5 max-w-xl text-lg leading-7 text-zinc-400 md:mx-0"
            >
            ...
            >
              ...
              <Button href="/maxime-2#solutions" variant="outline" size="lg">
                Explore solutions
              </Button>
            </motion.div>
          </div>
