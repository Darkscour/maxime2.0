    ...
    >
      <Container className="max-w-6xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="font-heading mt-2 text-2xl font-semibold tracking-tight text-[var(--foreground)] sm:text-3xl">
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
          {steps.map((step, i) => (
            <motion.div
              ...
              className="relative flex flex-col rounded-xl border border-[color-mix(in_srgb,var(--border)_50%,transparent)] bg-[var(--surface)] p-5"
            >
              <span className="font-heading text-xl font-semibold tracking-tight text-gradient">
                {step.number}
              </span>
              <h3 className="font-heading mt-3 text-sm font-semibold text-[var(--foreground)]">
                {step.title}
              </h3>
