    ...
    <IllustrationFrame accent="cyan" className="aspect-[16/10]">
      ...
      >
          ...
          return (
            <g key={i}>
              <text
                ...
                y={c.y}
                className={
                  c.active ? "fill-[color-mix(in_srgb,var(--accent)_85%,white)]" : "fill-[var(--foreground-subtle)]"
                }
                fontSize="8"
              ...
              {c.active && (
                <rect
                  ...
                  height="11"
                  rx="2"
                  className="stroke-[color-mix(in_srgb,var(--accent)_50%,transparent)] fill-[color-mix(in_srgb,var(--accent)_10%,transparent)]"
                  strokeWidth="1"
                />
              )}
            </g>
        ...
        <line
          ...
          x2={tapX - 12}
          y2={tapY - 4}
          className="stroke-[color-mix(in_srgb,var(--accent)_70%,transparent)]"
          strokeWidth="1.25"
          strokeDasharray="2 3"
        />
        ...
        <text
          ...
          y={tapY - 1}
          textAnchor="middle"
          className="fill-[color-mix(in_srgb,var(--accent)_70%,white)] font-mono"
          fontSize="9"
          letterSpacing="1"
        >
          M
        ...
        <circle
          ...
          cy={tapY - 4}
          r="20"
          className="stroke-[color-mix(in_srgb,var(--accent)_30%,transparent)]"
          strokeWidth="1"
          strokeDasharray="2 4"
        />
      </svg>
